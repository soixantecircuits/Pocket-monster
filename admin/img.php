<!--
	Allow to upload an image for a world/family/monster
-->
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<table>
			...
			<?php
			$type = $_GET['type'];
			if ((isset($_POST['name'])) && (($type == 'world') || ((isset($_POST['world_select']) && 
				($type == 'family' || (isset($_POST['family_select']) && $type == 'monster'))))))
			{
